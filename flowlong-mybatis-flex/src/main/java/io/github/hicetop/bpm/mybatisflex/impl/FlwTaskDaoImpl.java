...
public class FlwTaskDaoImpl implements FlwTaskDao {
    ...
    @Override
    public boolean deleteByInstanceIdAndParentTaskId(String instanceId, String parentTaskId) {
        QueryWrapper wrapper = QueryWrapper.create()
                .from(FlwTask.class)
                .where(FlwTask::getInstanceId).eq(instanceId)
                .and(FlwTask::getParentTaskId).eq(parentTaskId);
    ...
    @Override
    public Long selectCountByInstanceId(String instanceId) {
        QueryWrapper wrapper = QueryWrapper.create()
                .where(FlwTask::getInstanceId).eq(instanceId);
        return taskMapper.selectCountByQuery(wrapper);
    }
