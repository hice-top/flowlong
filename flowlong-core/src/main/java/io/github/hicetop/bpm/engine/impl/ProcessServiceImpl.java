...
import io.github.hicetop.bpm.engine.core.enums.FlowState;
...
public class ProcessServiceImpl implements ProcessService {
     ...
     */
    @Override
    public void updateType(String id, String processType) {
     ...
     */
    @Override
    public FlwProcess getProcessById(String id) {
     ...
     */
    @Override
    public String deploy(String processId, String jsonString, FlowCreator flowCreator, boolean repeat, Consumer<FlwProcess> processSave) {
