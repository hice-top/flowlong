...
import io.github.hicetop.bpm.engine.assist.StreamUtils;
...
public interface ProcessService {
     ...
     */
    FlwProcess getProcessById(String id);
     ...
     * @return 流程定义ID
     */
    default String deployByResource(String resourceName, FlowCreator flowCreator, boolean repeat) {
     ...
     * @return 流程定义ID
     */
    default String deployByResource(String resourceName, FlowCreator flowCreator, boolean repeat, Consumer<FlwProcess> processSave) {
     ...
     * @return 流程定义ID
     */
    default String deploy(InputStream input, FlowCreator flowCreator, boolean repeat) {
     ...
     * @return 流程定义ID
     */
    default String deploy(InputStream input, FlowCreator flowCreator, boolean repeat, Consumer<FlwProcess> processSave) {
     ...
     * @return 流程定义ID
     */
    String deploy(String processId, String jsonString, FlowCreator flowCreator, boolean repeat, Consumer<FlwProcess> processSave);
