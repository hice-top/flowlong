...
public interface RuntimeService {
     ...
     */
    boolean endInstance(Execution execution, String instanceId, NodeModel endNode, InstanceState instanceState);
     ...
     * @return true 成功 false 失败
     */
    boolean suspendInstanceById(String instanceId, FlowCreator flowCreator);
