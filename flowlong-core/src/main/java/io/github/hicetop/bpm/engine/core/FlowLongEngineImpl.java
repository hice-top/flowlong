 ...
 */
package io.github.hicetop.bpm.engine.core;
...
public class FlowLongEngineImpl implements FlowLongEngine {
     ...
     */
    @Override
    public Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, Map<String, Object> args, boolean saveAsDraft, Supplier<FlwInstance> supplier) {
     ...
     */
    @Override
    public void restartProcessInstance(String id, String currentNodeKey, Execution execution) {
        FlwProcess process = processService().getProcessById(id);
     ...
     */
    @Override
    public boolean executeTask(String taskId, FlowCreator flowCreator, Map<String, Object> args) {
        // 完成任务，并且构造执行对象
     ...
     */
    @Override
    public boolean autoJumpTask(String taskId, Map<String, Object> args, FlowCreator flowCreator) {
        return executeTask(taskId, flowCreator, args, TaskState.autoJump, TaskEventType.autoJump);
    }

    protected boolean executeTask(String taskId, FlowCreator flowCreator, Map<String, Object> args, TaskState taskState, TaskEventType eventType) {
     ...
     */
    @Override
    public boolean autoCompleteTask(String taskId, Map<String, Object> args, FlowCreator flowCreator) {
    ...
    @Override
    public Optional<FlwTask> executeJumpTask(String taskId, String nodeKey, FlowCreator flowCreator, Map<String, Object> args, TaskType taskTye) {
        // 执行任务跳转归档
    ...
    @Override
    public boolean executeAppendNodeModel(String taskId, NodeModel nodeModel, FlowCreator flowCreator, Map<String, Object> args, boolean beforeAfter) {
        // 追加指定节点模型
     ...
     */
    protected FlwInstance getFlwInstance(String instanceId, String updateBy) {
