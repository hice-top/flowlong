...
public class FlowLongEngineImpl implements FlowLongEngine {
     ...
     */
    @Override
    public Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, Map<String, Object> args, Supplier<FlwInstance> supplier) {
    ...
    private boolean afterDoneTask(FlowCreator flowCreator, FlwTask flwTask, Map<String, Object> args,
        ...
        String instanceId = flwTask.getInstanceId();
