...
import io.github.hicetop.bpm.engine.core.enums.ActorType;
...
@Setter
@ToString
@Table(value = "flw_his_task_actor")
public class FlwHisTaskActor extends FlwTaskActor {

    public static FlwHisTaskActor ofNodeAssignee(NodeAssignee nodeAssignee, String instanceId, String taskId) {
