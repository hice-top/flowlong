...
public class RuntimeServiceImpl implements RuntimeService {
     ...
     */
    @Override
    public boolean endInstance(Execution execution, String instanceId, NodeModel endNode, InstanceState instanceState) {
        FlwInstance flwInstance = instanceDao.selectById(instanceId);
        if (null != flwInstance) {
    ...
    protected FlwHisInstance getFlwHisInstance(String instanceId, NodeModel endNode, FlwInstance flwInstance, InstanceState instanceState) {
    ...
    @Override
    public boolean suspendInstanceById(String instanceId, FlowCreator flowCreator) {
