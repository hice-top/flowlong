...
public interface FlowLongEngine {
     ...
     */
    Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, Map<String, Object> args, boolean saveAsDraft, Supplier<FlwInstance> supplier);

    default Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, Map<String, Object> args, boolean saveAsDraft) {
        return this.startInstanceById(id, flowCreator, args, saveAsDraft, null);
    }

    default Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, Map<String, Object> args) {
        return this.startInstanceById(id, flowCreator, args, false);
    }

    default Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, String businessKey, boolean saveAsDraft) {
        return this.startInstanceById(id, flowCreator, null, saveAsDraft, () -> FlwInstance.of(businessKey));
    }

    default Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, String businessKey) {
        return this.startInstanceById(id, flowCreator, businessKey, false);
    }

    default Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator, boolean saveAsDraft) {
        return this.startInstanceById(id, flowCreator, null, saveAsDraft, null);
    }

    default Optional<FlwInstance> startInstanceById(String id, FlowCreator flowCreator) {
     ...
     */
    void restartProcessInstance(String id, String currentNode, Execution execution);
     ...
     */
    boolean executeTask(String taskId, FlowCreator flowCreator, Map<String, Object> args);

    default boolean executeTask(String taskId, FlowCreator flowCreator) {
     ...
     * @return true 成功 false 失败
     */
    boolean autoJumpTask(String taskId, Map<String, Object> args, FlowCreator flowCreator);

    default boolean autoJumpTask(String taskId, FlowCreator flowCreator) {
     ...
     * @return true 成功 false 失败
     */
    boolean autoCompleteTask(String taskId, Map<String, Object> args, FlowCreator flowCreator);

    default boolean autoCompleteTask(String taskId, FlowCreator flowCreator) {
        return this.autoCompleteTask(taskId, null, flowCreator);
    }

    default boolean autoCompleteTask(String taskId) {
     ...
     * @return true 成功 false 失败
     */
    default boolean executeJumpTask(String taskId, String nodeKey, FlowCreator flowCreator, Map<String, Object> args) {
        // 执行任务跳转归档
        return this.executeJumpTask(taskId, nodeKey, flowCreator, args, TaskType.jump).isPresent();
    }

    default boolean executeJumpTask(String taskId, String nodeKey, FlowCreator flowCreator) {
        return executeJumpTask(taskId, nodeKey, flowCreator, null);
    }

    Optional<FlwTask> executeJumpTask(String taskId, String nodeKey, FlowCreator flowCreator, Map<String, Object> args, TaskType taskTye);
     ...
     * @return 创建任务集合
     */
    List<FlwTask> createNewTask(String taskId, TaskType taskType, PerformType performType, List<FlwTaskActor> taskActors,
     ...
     * @return true 成功 false 失败
     */
    boolean executeAppendNodeModel(String taskId, NodeModel nodeModel, FlowCreator flowCreator, Map<String, Object> args, boolean beforeAfter);

    /**
     * 执行追加节点模型
     */
    default boolean executeAppendNodeModel(String taskId, NodeModel nodeModel, FlowCreator flowCreator, boolean beforeAfter) {
