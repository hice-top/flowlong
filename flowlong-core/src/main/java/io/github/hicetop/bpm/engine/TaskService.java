...
public interface TaskService {
     ...
     * @return Task 任务对象
     */
    default FlwTask complete(String taskId, FlowCreator flowCreator, Map<String, Object> args) {
        return this.executeTask(taskId, flowCreator, args, TaskState.complete, TaskEventType.complete);
    }

    default FlwTask complete(String taskId, FlowCreator flowCreator) {
     ...
     * @return Task 任务对象
     */
    FlwTask executeTask(String taskId, FlowCreator flowCreator, Map<String, Object> args, TaskState taskState, TaskEventType eventType);
     ...
     */
    boolean forceCompleteAllTask(String instanceId, FlwTask currentFlwTask, FlowCreator flowCreator, InstanceState instanceState, TaskEventType eventType);
     ...
     */
    Optional<FlwTask> executeJumpTask(String taskId, String nodeKey, FlowCreator flowCreator, Map<String, Object> args, Function<FlwTask, Execution> executionFunction, TaskType taskTye);

    default boolean executeJumpTask(String taskId, String nodeKey, FlowCreator flowCreator, Map<String, Object> args, Function<FlwTask, Execution> executionFunction) {
        return executeJumpTask(taskId, nodeKey, flowCreator, args, executionFunction, TaskType.jump).isPresent();
    }

    default boolean executeJumpTask(String taskId, String nodeKey, FlowCreator flowCreator, Function<FlwTask, Execution> executionFunction) {
     ...
     * @return true 成功 false 失败
     */
    boolean completeActiveTasksByInstanceId(String instanceId, FlowCreator flowCreator);
     ...
     * @return true 成功 false 失败
     */
    boolean viewTask(String taskId, FlwTaskActor taskActor);
     ...
     * @return Task 任务对象
     */
    FlwTask claimRole(String taskId, FlowCreator flowCreator);
     ...
     * @return Task 任务对象
     */
    FlwTask claimDepartment(String taskId, FlowCreator flowCreator);
     ...
     * @return true 成功 false 失败
     */
    default boolean agentTask(String taskId, FlowCreator flowCreator, List<FlowCreator> agentFlowCreators, Map<String, Object> args) {
        return this.assigneeTask(taskId, TaskType.agent, flowCreator, agentFlowCreators, args, null);
    }

    default boolean agentTask(String taskId, FlowCreator flowCreator, List<FlowCreator> agentFlowCreators) {
     ...
     * @return true 成功 false 失败
     */
    default boolean transferTask(String taskId, FlowCreator flowCreator, FlowCreator assigneeFlowCreator, Map<String, Object> args) {
        return this.assigneeTask(taskId, TaskType.transfer, flowCreator, Collections.singletonList(assigneeFlowCreator), args, null);
    }

    default boolean transferTask(String taskId, FlowCreator flowCreator, FlowCreator assigneeFlowCreator) {
     ...
     * @return true 成功 false 失败
     */
    default boolean delegateTask(String taskId, FlowCreator flowCreator, FlowCreator assigneeFlowCreator, Map<String, Object> args) {
        return this.assigneeTask(taskId, TaskType.delegate, flowCreator, Collections.singletonList(assigneeFlowCreator), args, null);
    }

    default boolean delegateTask(String taskId, FlowCreator flowCreator, FlowCreator assigneeFlowCreator) {
     ...
     * @return true 成功 false 失败
     */
    boolean assigneeTask(String taskId, TaskType taskType, FlowCreator flowCreator, List<FlowCreator> assigneeFlowCreators, Map<String, Object> args, Function<FlwTask, Boolean> check);

    default boolean assigneeTask(String taskId, TaskType taskType, FlowCreator flowCreator, List<FlowCreator> assigneeFlowCreators) {
     ...
     * @return true 成功 false 失败
     */
    boolean resolveTask(String taskId, FlowCreator flowCreator);
     ...
     * @return Task 任务对象
     */
    Optional<FlwTask> withdrawTask(String taskId, FlowCreator flowCreator);
     ...
     * @return 创建任务集合
     */
    List<FlwTask> createNewTask(String taskId, TaskType taskType, PerformType performType, List<FlwTaskActor> taskActors, FlowCreator flowCreator, Function<FlwTask, Execution> executionFunction);
     ...
     * @return true 成功 false 失败
     */
    boolean addTaskActor(String taskId, PerformType performType, List<FlwTaskActor> taskActors, FlowCreator flowCreator);

    default boolean addTaskActor(String taskId, PerformType performType, FlwTaskActor taskActor, FlowCreator flowCreator) {
        return this.addTaskActor(taskId, performType, Collections.singletonList(taskActor), flowCreator);
    }

    default boolean addTaskActor(String taskId, List<FlwTaskActor> taskActors, FlowCreator flowCreator) {
        return this.addTaskActor(taskId, null, taskActors, flowCreator);
    }

    default boolean addTaskActor(String taskId, FlwTaskActor taskActor, FlowCreator flowCreator) {
     ...
     * @return true 成功 false 失败
     */
    boolean removeTaskActor(String taskId, List<String> actorIds, FlowCreator flowCreator);

    default boolean removeTaskActor(String taskId, String actorId, FlowCreator flowCreator) {
     ...
     * @return true 成功 false 失败
     */
    boolean changeTaskActor(String taskId, FlwTaskActor taskActor);
     ...
     */
    void endCallProcessTask(String callProcessId, String callInstanceId);
     ...
     */
    boolean cascadeRemoveByInstanceIds(List<String> instanceIds);
}