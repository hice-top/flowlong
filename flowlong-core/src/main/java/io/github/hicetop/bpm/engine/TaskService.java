...
public interface TaskService {
     ...
     * @return true 成功 false 失败
     */
    boolean assigneeTask(String taskId, TaskType taskType, FlowCreator flowCreator, List<FlowCreator> assigneeFlowCreators, Function<FlwTask, Boolean> check);
     ...
     * @return true 成功 false 失败
     */
    boolean addTaskActor(String taskId, PerformType performType, List<FlwTaskActor> flwTaskActors, FlowCreator flowCreator);

    default boolean addTaskActor(String taskId, PerformType performType, FlwTaskActor flwTaskActor, FlowCreator flowCreator) {
