...
ALTER TABLE "flw_ext_instance"
    ADD CONSTRAINT "SYS_C0012294" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_ext_instance
-- ----------------------------
ALTER TABLE "flw_ext_instance"
    ADD CONSTRAINT "SYS_C0012236" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_ext_instance"
    ADD CONSTRAINT "SYS_C0012238" CHECK ("process_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table flw_his_instance
-- ----------------------------
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012296" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_his_instance
-- ----------------------------
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012240" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012243" CHECK ("create_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012246" CHECK ("create_by" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012249" CHECK ("create_time" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012251" CHECK ("process_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012253" CHECK ("current_node_name" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012255" CHECK ("current_node_key" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_instance"
    ADD CONSTRAINT "SYS_C0012257" CHECK ("instance_state" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012297" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_his_task
-- ----------------------------
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012241" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012244" CHECK ("create_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012247" CHECK ("create_by" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012250" CHECK ("create_time" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012252" CHECK ("instance_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012254" CHECK ("task_name" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012256" CHECK ("task_key" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012258" CHECK ("task_type" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012259" CHECK ("remind_repeat" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012260" CHECK ("viewed" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task"
    ADD CONSTRAINT "SYS_C0012261" CHECK ("task_state" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "flw_his_task_actor"
    ADD CONSTRAINT "SYS_C0012295" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_his_task_actor
-- ----------------------------
ALTER TABLE "flw_his_task_actor"
    ADD CONSTRAINT "SYS_C0012235" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task_actor"
    ADD CONSTRAINT "SYS_C0012237" CHECK ("instance_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task_actor"
    ADD CONSTRAINT "SYS_C0012239" CHECK ("task_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task_actor"
    ADD CONSTRAINT "SYS_C0012242" CHECK ("actor_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task_actor"
    ADD CONSTRAINT "SYS_C0012245" CHECK ("actor_name" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_his_task_actor"
    ADD CONSTRAINT "SYS_C0012248" CHECK ("actor_type" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012298" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_instance
-- ----------------------------
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012262" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012263" CHECK ("create_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012264" CHECK ("create_by" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012265" CHECK ("create_time" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012266" CHECK ("process_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012267" CHECK ("current_node_name" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_instance"
    ADD CONSTRAINT "SYS_C0012268" CHECK ("current_node_key" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012299" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_process
-- ----------------------------
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012269" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012270" CHECK ("create_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012271" CHECK ("create_by" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012272" CHECK ("create_time" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012273" CHECK ("process_key" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012274" CHECK ("process_name" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012275" CHECK ("process_version" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012276" CHECK ("use_scope" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_process"
    ADD CONSTRAINT "SYS_C0012277" CHECK ("process_state" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012300" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_task
-- ----------------------------
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012282" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012284" CHECK ("create_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012286" CHECK ("create_by" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012287" CHECK ("create_time" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012288" CHECK ("instance_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012289" CHECK ("task_name" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012290" CHECK ("task_key" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012291" CHECK ("task_type" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012292" CHECK ("remind_repeat" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task"
    ADD CONSTRAINT "SYS_C0012293" CHECK ("viewed" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "flw_task_actor"
    ADD CONSTRAINT "SYS_C0012301" PRIMARY KEY ("id");

-- ----------------------------
-- Checks structure for table flw_task_actor
-- ----------------------------
ALTER TABLE "flw_task_actor"
    ADD CONSTRAINT "SYS_C0012278" CHECK ("id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task_actor"
    ADD CONSTRAINT "SYS_C0012279" CHECK ("instance_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task_actor"
    ADD CONSTRAINT "SYS_C0012280" CHECK ("task_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task_actor"
    ADD CONSTRAINT "SYS_C0012281" CHECK ("actor_id" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task_actor"
    ADD CONSTRAINT "SYS_C0012283" CHECK ("actor_name" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "flw_task_actor"
    ADD CONSTRAINT "SYS_C0012285" CHECK ("actor_type" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
