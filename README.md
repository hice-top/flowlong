...
> 🔴附加协议：使用方在项目介绍中显著位置`必须标注`版权信息`（链接仓库地址）`，`不允许删除源码注释申明`，`不允许山寨换皮商用与官方企业版竞争`
> ，否则视为侵权`（索赔100万）`。
...
托管  [GitHub](https://github.com/aizuda/flowlong)  [Gitee](https://gitee.com/aizuda/flowlong)  [GitCode](https://gitcode.com/aizuda/flowlong)
仓库
