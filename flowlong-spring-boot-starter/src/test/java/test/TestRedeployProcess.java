 ...
 */
@Transactional
public class TestRedeployProcess extends SqlServerTest {
    ...
    public void test() {
        ...
        String processIdV2 = flowLongEngine.processService().deployByResource("test/sortSignV2.json", testCreator, true);
