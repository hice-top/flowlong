...
import io.github.hicetop.bpm.engine.model.DynamicAssignee;
 ...
 * @since 1.0
 */
public class TestReloadProcessModel extends SqlConfigTest {
    ...
    private void dynamicAssigneeAndExecuteTask(String instanceId, String nodeKey, FlowCreator flowCreator, FlowCreator taskCreator) {
        // 传递动态分配处理人员
