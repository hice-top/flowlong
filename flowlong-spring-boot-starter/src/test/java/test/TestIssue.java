 ...
 * issue 问题测试
 */
public class TestIssue extends SqlServerTest {
    ...
    public void testFlwProcessPage() {
        QueryWrapper wrapper = QueryWrapper.create()
                .where(FlwProcess::getProcessName).like("审批")
                .orderBy(FlwProcess::getSort).asc();
        Page<FlwProcess> page = flwProcessMapper.paginate(new Page<>(1, 10), wrapper);
        Assertions.assertTrue(page.getTotalPage() >= 0);
    }
    ...
    public void testRejectTask() {
        String processId = this.deployByResource("test/subProcess.json", testCreator);
    ...
    public void testConditionEnd() {
        String processId = this.deployByResource("test/conditionEnd.json", testCreator);
    ...
    public void testFlwInstanceVariable() {
        String processId = this.deployByResource("test/purchase.json", testCreator);
    ...
    public void testI9HTX1() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_I9HTX1.json", testCreator, false);
    ...
    public void test_I9O8GV() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_I9O8GV.json", testCreator, false);
    ...
    public void test_I9SVKP() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_I9SVKP.json", testCreator, false);
    ...
    public void test_IAAVIR() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_IAAVIR.json", testCreator, false);
    ...
    public void test_IAAVIR_countersign() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_IAAVIR_countersign.json", testCreator, false);
    ...
    public void test_IAAVIR_orSign() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_IAAVIR_orSign.json", testCreator, false);
    ...
    public void test_IAAVIR_voteSign() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_IAAVIR_voteSign.json", testCreator, false);
    ...
    public void issues_IB7SSY() {
        ...
        // 部署流程
        String processId = processService.deployByResource("test/issues_IB7SSY.json", testCreator, false);
